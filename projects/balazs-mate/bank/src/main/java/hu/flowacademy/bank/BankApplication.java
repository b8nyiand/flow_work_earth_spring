    ...
    public CommandLineRunner runner() {
        return args -> {
            ...
            if (bankUserService.findAll().isEmpty()) {
                ...
                BankAccount account01a = new BankAccount("01010101", 500000, Currency.HUF, user01);
                BankAccount account01b = new BankAccount("01044124442", 50000, Currency.USD, user01);
