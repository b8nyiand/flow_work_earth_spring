    ...
    public CommandLineRunner runner() {
        return args -> {
            ...
            if (bankUserService.findAll().isEmpty()) {
                ...
                BankAccount account01a = new BankAccount("01010101", 500000, Currency.HUF, LocalDate.of(2011, 12, 20), user01);
                BankAccount account01b = new BankAccount("01044124442", 50000, Currency.USD, LocalDate.of(2012, 12, 21), user01);
                ...
                BankAccount account02 = new BankAccount("0101000101", 100000, Currency.HUF, LocalDate.of(2013, 12, 22), user02);
                ...
                BankAccount account03 = new BankAccount("010100550101", 230000, Currency.EUR, LocalDate.of(2014, 01, 10), user03);
