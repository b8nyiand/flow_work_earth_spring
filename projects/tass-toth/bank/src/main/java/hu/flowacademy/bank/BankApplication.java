    ...
    CommandLineRunner runner() {
        return args -> {
            if (customerRepository.findAll().isEmpty()) {
                ...
                BankAccount account1 = new BankAccount("123456", 5000, "HUF", customer1, LocalDate.now());
                BankAccount account2 = new BankAccount("654321", 10000, "EUR", customer2, LocalDate.now());
